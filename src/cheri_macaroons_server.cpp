...
int main(int argc, char *argv[])
{
    ...
    macaroons::Macaroon server_macaroon;
    ...
    /* Initialise Macaroon in tab_string */
    if(shim_type == MACAROONS || shim_type == CHERI_MACAROONS) {
        server_macaroon = macaroons::Macaroon(location, key, id);
        std::string serialised = server_macaroon.serialize();
